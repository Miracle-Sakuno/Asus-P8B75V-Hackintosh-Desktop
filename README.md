...
SkyLake used to have two important components, FWH and LPC (Firmware Hub/Low Pin Count). After SkyLake, Intel used a new specification. The two components were integrated into PMC (Power Management Controller), more or less with PMCR/PPMC. The function implementation is related, because I think it is necessary to load.
